...
public class BeerServiceJPA implements BeerService {
    ...
    public Page<BeerDTO> listBeers(String beerName, BeerStyle beerStyle, Boolean showInventory, Integer pageNumber, Integer pageSize) {
        PageRequest pageRequest = buildPageRequest("beerName",pageNumber,pageSize);
        Page<Beer> beerPage;
    ...
    public PageRequest buildPageRequest(String orderByField,Integer pageNumber, Integer pageSize) {
        int queryPageNumber;
        int queryPageSize;
        ...
        Sort sort = Sort.by(Sort.Order.asc(orderByField));
